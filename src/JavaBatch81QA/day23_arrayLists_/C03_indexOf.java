...
public class C03_indexOf {
    public static void main(String[] args) {
        ...
        // list primitive data turlerini kabul etmez. sadece referanslarini saklar
        // bu yuzden biz indexOf metodunun icine object yazariz
        System.out.println(urunler.indexOf("Ikram")); // 1 --> liste degismez indexi verir
