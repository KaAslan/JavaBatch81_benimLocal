...
public class KArrayListMethods_trQAteam14 {
    public static void main(String[] args) {
        ...
        // 2-set() methodu var olan bir elemani baskasiyla degistirmeye yarar.
            //--> isimlerList.set(1,"elma")


        // 3-remove() methodu silmeye yarar iki sekilde yapilir.
        // ---> urunlerListesi.remove("elma(obj.ismi)") ---true false doner
        // ---> urunlerListesi.remoe(1(indexBulunduguYer)) ----- silinen eleman doner
        ...
        // ---> isimlerListesi.contain("Ali") --- true false doner


        // 6-get() methodu ise List te istenen index teki elemanlari getirir.
        // ---> urunlerListesi.get(index) --- o indexteki ELEMANLARİ GETİRİR.


        // 7-size() methodu kac eleman oldugunu verir.uzunlugu da diyebiliriz.
        // ---> urunlerListesi.size() - LİSTTE BOYUTU VERİR. ARRAYDE .lenght() KULLANILIR.
        ...
        // --->isimlerListesi.clear() --- ICINE INDEX YADA OBJECT YAZİLMAZ. SADECE LİSTEYİ TEMİZLER

        // 9-isEmpty methodu ise List in ici bos ise truE dolu ise false olarak dondurmeye yarar.
        // ---> is.Empty()-BOŞ MU DEMEKTİR. -- TRUE FALSE DONER

        // 10-equals() methodu ise List lerin yani birden fazla list in icindeki elemanlari kiyaslar
        // ---> LISTELERİN ESİT OLUP OLMADIGINI KONTROL EDER. LIST ICINDEKİ ELEMANLARI KIYASLAR-- TRUE FALSE DONER
