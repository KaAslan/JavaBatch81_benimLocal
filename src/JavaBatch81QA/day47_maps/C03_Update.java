...
public class C03_Update {
    public static void main(String[] args) {
        ...
        //todo soru: Verilen map'de JDev degerlerini JavaDeveloper olarak degistirelim

        //NOT: Map'lerde replace tum value'yu degistirmek istersek kullanilabilir
        ...
        Set<Integer> keySeti = sinifListMap.keySet();//key'lere ulasa bilmek icin Integerlerden olusanset olusturduk
        String eachValue;
