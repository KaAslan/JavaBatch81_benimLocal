...
public class K_ChildClassOfInterfaces implements I02_Interfaces, I03_Interfaces {
    ...
    public static void main(String[] args) {
        ...
        /* birden cok interface implement ettigimizide variable isimlerinde cakisma olabilir.
        bunun onune gecmek icin InterfaceIsmi.VariableIsmi seklinde yazmaliyiz
        methodlarda override ettgi icin gerek yoktur
         */
