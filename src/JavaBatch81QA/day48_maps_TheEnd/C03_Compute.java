package JavaBatch81QA.day48_maps_TheEnd;
...
public class C03_Compute {
    public static void main(String[] args) {
        ...
        System.out.println("harfMapi = " + harfMapi);// {A=5, B=1, C=2, D=4, E=4}
       ...
       harfMapi.computeIfPresent("G" , (k,v)-> v+5);
        ...
        System.out.println("harfMapi = " + harfMapi);// {A=13, B=1, C=2, D=4, E=4}
