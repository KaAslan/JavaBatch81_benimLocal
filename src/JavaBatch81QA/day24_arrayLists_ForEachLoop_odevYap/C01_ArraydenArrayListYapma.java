...
public class C01_ArraydenArrayListYapma {
    public static void main(String[] args) {
        ...
        List<String> sinifList= Arrays.asList(arr); // yukaridaki arrayi list yaptik.

        System.out.println(sinifList); // [Ismail, Nurullah, Fatih]
        // 1.yan etki
        // sinifList.add("Erdi"); // UnsupportedOperationException (arrayden olusturulan listte .add()metodu calismadi)
        // sinifList.remove(1); // UnsupportedOperationException (arrayden olusturulan listte remove()metodu calismadi)

        // 2.yan etki
        arr[1] ="Emre";  /// --> array degisince listte etkilendi
        ...
        sinifList.set(0,"Utku"); // --> listi degistirmis olmama ragmen arrayde etkilendi
