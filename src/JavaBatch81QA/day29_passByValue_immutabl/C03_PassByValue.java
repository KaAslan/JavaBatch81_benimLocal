package JavaBatch81QA.day29_passByValue_immutabl;
...
public class C03_PassByValue {
    public static void main(String[] args) {
        ...
        System.out.println("eleman degistir methodundan sonra main m. icinde list : " + list);
        // [ Oguz, Murat, Fatih]

        listDegistir(list);


        System.out.println("list degistir methodundan sonra  main m. icinde list : " + list);
        // [ Oguz, Murat, Fatih]
    }
