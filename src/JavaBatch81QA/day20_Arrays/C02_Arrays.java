...
public class C02_Arrays {
    public static void main(String[] args) {
        ...
        System.out.println(sayilar); // [I@58ceff1 --> non primitve data turu oldugu icin stackde saklanir.
        //o yuzden direk yazdirinca referans vardir.
        ...
        System.out.println(Arrays.toString(sayilar)); // [5, 3, 10]  --> index sırasina gore yazar
