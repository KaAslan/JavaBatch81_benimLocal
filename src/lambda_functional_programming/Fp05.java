...
public class Fp05 {
    public static void main(String[] args) {
        ...
        System.out.println("ortlamaPuanlarVerilenSayidanBuyukMu : " + ortlamaPuanlarVerilenSayidanBuyukMu(coursesList,75));

        System.out.println("herhangiBirKursAdiKelimeyiIceriyorMu :  "+ herhangiBirKursAdiKelimeyiIceriyorMu(coursesList,"Turkish"));

        System.out.print("ortalamasiEnYuksekKursunAdiniYazdir :  ");
                ortalamasiEnYuksekKursunAdiniYazdir(coursesList);


        System.out.println("ortalamaPuanaGoreSiralaVeIlkVerilenleriAtla : " +
                ortalamaPuanaGoreSiralaVeIlkVerilenleriAtla(coursesList,3));

    }

        //1)Tüm ortalama puanların verilen sayıdan büyük olup olmadığını kontrol etmek için bir method oluşturun.
        public static boolean ortlamaPuanlarVerilenSayidanBuyukMu(List<Courses> list, double x) {
