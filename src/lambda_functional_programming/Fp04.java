...
public class Fp04 {
    public static void main(String[] args) {
        ...
        System.out.println("faktoryelBul : " + faktoryelHesapla(5));

        System.out.println("verilen2SayiArasindakiCiftSayilarinToplamini : "
                + verilen2SayiArasindakiCiftSayilarinToplamini(7,5));

        System.out.println("ikiSayiArasindakiTumSayilarinRakamlariToplami : " +
                ikiSayiArasindakiTumSayilarinRakamlariToplami(13,11));
    ...
    //______________________ 1.yol
    public static int get7den100eToplam01(){

        return  IntStream.range(7,101).reduce(Math::addExact).getAsInt();
        // IntStream.range(7,101).reduce(0,Math::addExact).;
    }

    //______________________ 2.yol
    ...
    public static int faktoryelHesapla(int x) {
        if (x>0){ return IntStream.rangeClosed(1, x).reduce(Math::multiplyExact).getAsInt();}
    ...
    public static int verilen2SayiArasindakiCiftSayilarinToplamini(int x, int y){
